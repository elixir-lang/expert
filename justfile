...
compile project *args="": mix-local (deps project)
...
[doc('Run mix local.hex and mix local.rebar')]
mix-local:
...
[unix]
burrito-local: mix-local (deps "engine") (deps "expert")
  #!/usr/bin/env bash
  cd apps/expert
...
burrito: mix-local (deps "engine") (deps "expert")
  #!/usr/bin/env bash
  cd apps/expert
...
[unix]
release: mix-local (deps "engine") (deps "expert")
  #!/usr/bin/env bash
  cd apps/expert
