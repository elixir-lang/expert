defmodule Engine.Mix do
  ...
  def in_project(%Project{mix_project?: false}, fun) do
    run_and_normalize(fn -> fun.(nil) end)
  end

  def in_project(%Project{mix_project?: true} = project, fun) do
    with_lock(fn ->
  ...
  defp ensure_project_loaded(%Project{mix_project?: true, project_module: nil} = project) do
